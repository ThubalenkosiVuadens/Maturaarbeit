...
/*************************************************************************************************/
  ...
  /**************************************************************************************/
    ...
    /***************************    independent sensors    ********************************/
      ...
      #define FORCE_ACC_ORIENTATION(Y, X, Z)  {imu.accADC[ROLL]  =  Y; imu.accADC[PITCH]  = X; imu.accADC[YAW]  = Z;}//unkommentiert, X,Y getauscht, vorzeichen der ehemals anderen variablen übernommen, 
      #define FORCE_GYRO_ORIENTATION(Y, X, Z) {imu.gyroADC[ROLL] = -X; imu.gyroADC[PITCH] =  Y; imu.gyroADC[YAW] = -Z;}
